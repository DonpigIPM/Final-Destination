#> assets:armor_stand/early/sticky_snare/_
...
# set data
    execute if predicate entity:is_on_ground run function assets:armor_stand/early/sticky_snare/set_data
...
# boom
    execute if entity @s[tag=OnGround] positioned ~-0.5 ~ ~-0.5 if entity @n[type=!#entity:spiders,dx=1] run function assets:armor_stand/early/sticky_snare/boom
