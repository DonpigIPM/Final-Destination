#> assets:armor_stand/mid/bouncy_mucus/_
...
# hit
    execute positioned ~-0.5 ~-0.5 ~-0.5 if entity @p[dx=1] positioned ~0.5 ~0.5 ~0.5 if entity @p[dx=1] run tag @s add Hitted
    execute if entity @s[tag=Hitted] run function assets:armor_stand/mid/bouncy_mucus/hit