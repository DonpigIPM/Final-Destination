...
# AI
    ...
    execute if score @s AITimer matches 100 run function entity:early/breeze/act/wind_burst/_
    execute if score @s AITimer matches 200.. if predicate entity:is_on_ground if entity @s[tag=WindBurstReady] run function entity:early/breeze/act/wind_burst/act