#> entity:early/blaze/act/blazing_flame/fireball_init

# set data
    tp @s ~ ~ ~ facing entity @n[tag=MobTarget]
    execute rotated as @s positioned 0.0 0.0 0.0 run summon minecraft:armor_stand ^ ^ ^1.0 {Tags:["FireballMotion"],Marker:1b,Invisible:1b}
