#> entity:enderman/act/eye_from_the_end/_
...
# check
    ...
    scoreboard players operation #UsedTime Temporary += #300 Constant
    execute if score #UsedTime Temporary <= #UsingTime Temporary run function entity:enderman/act/eye_from_the_end/act
