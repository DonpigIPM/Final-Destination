#> entity:mid/zombies/husk/act/starvation_aura/_
...
# act
    ...
    execute positioned ~-2.5 ~-2.5 ~-2.5 as @e[dx=4,dy=4,dz=4,type=!#minecraft:zombies] run function entity:mid/zombies/husk/act/starvation_aura/effect
