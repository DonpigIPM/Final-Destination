#> entity:mid/enderman/act/eye_from_the_end/_
...
# check
    ...
    execute if score #UsedTime Temporary <= #UsingTime Temporary run function entity:mid/enderman/act/eye_from_the_end/act
