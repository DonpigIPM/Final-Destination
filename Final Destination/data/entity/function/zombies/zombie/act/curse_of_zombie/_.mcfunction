#> entity:zombies/zombie/act/curse_of_zombie/_
...
# act
    ...
    execute positioned ~-2.5 ~-2.5 ~-2.5 as @e[dx=4,dy=4,dz=4,type=!#minecraft:zombies] run function entity:zombies/zombie/act/curse_of_zombie/effect
